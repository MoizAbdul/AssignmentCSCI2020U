...
public class Assignmentq3 extends Application {
    ...
    private Circle[] circle = {new Circle(300, 125, 10),
            new Circle(100, 125, 10), new Circle(200, 225, 10),
            new Circle(200,125, 100)};
    ...
    public void start(Stage primaryStage) {
        ...
        circle[3].setFill(Color.TRANSPARENT);
        circle[3].setStroke(Color.BLACK);
        circle[2].setFill(Color.RED);
        circle[0].setFill(Color.RED);
        circle[1].setFill(Color.RED);
        setLines();
        pane.getChildren().addAll(circle[0], circle[1], circle[2],circle[3],
        ...
        circle[0].setOnMouseDragged((MouseEvent me)-> {
            Point2D redCenter = new Point2D(circle[3].getCenterX(), circle[3].getCenterY());
            Point2D mouse = new Point2D(me.getX(), me.getY());
            Point2D centerToMouse = mouse.subtract(redCenter);
            Point2D centerToNewPoint = centerToMouse.normalize().multiply(circle[3].getRadius());
